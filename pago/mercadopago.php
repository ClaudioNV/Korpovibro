...
class MP {
     ...
     * @return array(json)
     */
    public function get_payment($id,$monto) {
    ...
    */    
    public function get_authorized_payment($id) {
        ...
        return $authorized_payment_info;
         ...
         mysql_query("UPDATE app_punto_pago SET punto_pago_estado = 'pagado' WHERE punto_pago_transaccion = '55697845'  AND punto_pago_estado = 'pendiente';");
    }
    ...
    public function create_preference($preference) {
        ...
        $collection_id = date("collection_id");
   
        $access_token = $this->get_access_token();

        $preference_result = MPRestClient::post("/checkout/preferences?access_token=" . $access_token, $preference);

      mysql_query("INSERT INTO mercado_pago(mercado_pago_token, mercado_pago_transaccion, mercado_pago_producto, mercado_pago_cotizacion, mercado_pago_monto, mercado_pago_fecha, mercado_pago_estado) VALUES ('".$trx_id."', '".$trx_id."', '".$prod."', '".$cot."', '".$monto."', '".$fecha."', 'pendiente')");
        return $preference_result;
    }
