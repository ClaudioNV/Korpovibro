  ...
  <section>
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
          <div class="text-center">
            <div class="col-md-2 col-sm-5 col-xs-12">
              <!-- <img src="img/slider/CLAUDIO.jpeg" class="avatar img-circle img-thumbnail" alt="avatar" id="foto"> -->
    ...
    <div id="sticky" class="container">
        ...
        <ul class="nav nav-tabs nav-menu " role="tablist">
          ...
          <li  class="active"><a href="http://korpovibro.cl/perfil-instructor.php">
            Perfil
            </a>
          </li>
...
<br>
    ...
    <script src="js/perfil-instructor.js?v=4"></script>
     <script src="js/verificar-header.js?v=4"></script>
