var repos = "http://korpovibro.cl/modelo/common-buscar-clases-home.php";
            ...
            .done(function (data) {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    if (usuario.latitud != "") { // valido que el campo de la latitud no este vacio
                       ...
                       var value = "<center style='width:180px;'><img style ='width: 6em;' src ='" + imgtipo + "'><br><span style='font-size:1.5em;color:#da8160;'><b>" + usuario.instructor + "</b></span><br><br><a href='#' class='datosClase btn1 btn-primary btn-xs ' style='margin-top: 2%;'\
